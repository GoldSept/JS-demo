/**
 * @Author: ATang
 * @Date: 2022-06-14 12:52:46
 * @LastEditors: error: git config user.name && git config user.email & please set dead value or install git
 * @LastEditTime: 2022-09-21 16:26:34
 * @FilePath: \JS笔记+项目\Demo\Cinema\Demo2\cinema.js
 * @Description:
 * @🔆神明保佑，永无BUG🔆
...
// 动态生成li标签
for (var i = 0; i < Math.floor(oUl.getBoundingClientRect().height / 70) * 6; i++) {
